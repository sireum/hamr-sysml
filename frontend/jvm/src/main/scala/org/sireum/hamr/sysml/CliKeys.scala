...
object ShortKeys {
  ...
  val allKeys: Set[String] = Set.empty[String] ++ ISZ(verbose, runtimeMonitoring, platform, outputDir, Slang_packageName, Transpiler_excludeComponentImpl, Transpiler_bitWidth, Transpiler_maxStringSize, Transpiler_maxArraySize, Transpiler_runTranspiler, CAmkES_workspaceRootDir, ROS2_ros2Dir, ROS2_ros2NodesLanguage, ROS2_ros2LaunchLanguage, Experimental_experimentalOptions)
